...
transitioned_nts_master = spark.read.csv(f"/mnt/disk/staging_data/test/{domain_id}/transitioned_raw_nts_master_{domain_id}.csv",inferSchema=True,header=True)
...
npf_master = npf_master.filter(npf_master.domain_id==domain) # New line after implementing npf
#npf_master = npf_master.filter(npf_master.domain_id==domain_id)# old line before npf implement
