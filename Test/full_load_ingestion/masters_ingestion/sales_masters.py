...
product_data = df_union.filter(df_union.hierarchy_type == 'product').withColumnRenamed('hierarchy_value','product_id').withColumnRenamed('description','product_desc').drop('hierarchy_type','parent_value')
...
# Replacing  ' ' with '_' 
product_data=product_data.withColumn('product_id', regexp_replace('product_id', ' ', '_'))
...
org_unit_data = df_union.filter(df_union.hierarchy_type == 'org_unit').withColumnRenamed('hierarchy_value','org_unit_id').withColumnRenamed('description','org_unit_desc').drop('hierarchy_type','parent_value')
...
channel_data = df_union.filter(df_union.hierarchy_type == 'channel').withColumnRenamed('hierarchy_value','channel_id').withColumnRenamed('description','channel_desc').drop('hierarchy_type','parent_value')
