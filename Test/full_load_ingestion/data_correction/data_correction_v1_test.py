...
raw_history_master = spark.read.csv(f"/mnt/disk/staging_data/{env}/{domain}/filtered_active_npi_raw_history_master_{domain}.csv",inferSchema=True,header=True)
...
data_correction = spark.read.csv(f"/mnt/disk/staging_data/{env}/{domain}/transitioned_data_correction_{domain}.csv",inferSchema=True,header=True)
