...
#raw_npf_master= spark.read.csv(f"/mnt/disk/staging_data/{env}/{domain_id}/incremental_staging_data/{domain_id}_npf_master.csv",inferSchema=True,header=True)

# COMMAND ----------

#raw_npf_master.display()
