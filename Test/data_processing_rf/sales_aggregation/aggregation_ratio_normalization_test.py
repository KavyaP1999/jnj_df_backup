...
# disable proportion length from aggregation page---
...
try:
    ...
    if (product_forecast_level == product_input_level) and (channel_forecast_level == channel_input_level) and (org_unit_forecast_level == org_unit_input_level):
       ...
       ## Ingesting in the blob storage
        ...
        #below lines ratio_table as well if/else block commented to remove duplicates from F5
                #Ratio creation
    ...
    # below lines commented for removing duplicates from f5
