...
# Reading from DataBASE old code line
...
#npf_master = npf_master.filter(npf_master.domain_id==domain_id)# Added new line for testing purpose with new npf and giving error
