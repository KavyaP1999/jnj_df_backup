...
# MAGIC %run /Shared/Prod/forecasting/models/arima

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/auto_ets

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/croston

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/linear_regression

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/naive_forecast

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/prophet_univariate

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/randomForest_univariate

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/sarima

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/tbats_sktime

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/xgBoost_simple

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/bagged_ets

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/static_ets

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/lstm

# COMMAND ----------

# MAGIC %run /Shared/Prod/forecasting/models/MLP
