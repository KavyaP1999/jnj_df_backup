...
df = spark.read.csv(f"/mnt/disk/staging_data/{env}/{domain_id}/incremental_staging_data/{domain_id}_channel_master.csv",inferSchema=True,header=True)
...
db_ingestion(df, 'channel', 'append')
