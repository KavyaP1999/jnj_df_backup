...
# new final.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").mode("OverWrite").save(f"/mnt/disk/staging_data/{env}/{domain_id}/transitioned_raw_npf_master_{domain_id}.csv") 
...
raw_future_forecast_master.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").mode("OverWrite").save(f"/mnt/disk/staging_data/prod/{domain_id}/transitioned_raw_future_forecast_master_{domain_id}.csv") 
...
raw_nts_master.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").mode("OverWrite").save(f"/mnt/disk/staging_data/prod/{domain_id}/transitioned_raw_nts_master_{domain_id}.csv")
...
raw_past_forecast_master.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").mode("OverWrite").save(f"/mnt/disk/staging_data/prod/{domain_id}/transitioned_raw_past_forecast_master_{domain_id}.csv") 
...
raw_history_master.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").mode("OverWrite").save(f"/mnt/disk/staging_data/prod/{domain_id}/transitioned_raw_history_master_{domain_id}.csv") 
...
data_correction_master.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").mode("OverWrite").save(f"/mnt/disk/staging_data/prod/{domain_id}/transitioned_data_correction_{domain_id}.csv") 
