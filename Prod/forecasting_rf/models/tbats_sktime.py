...
# # New code version_2.2.10_1
# # Only "use_damp_trend" has been changed from old code and "n_jobes = -1"
# def tbats_sktime(df1, forecast_length,sp=12,use_trend=True, use_damped_trend=None, use_arma_errors=False,use_box_cox=False):
#     fh = np.arange(1,forecast_length+1)
#     df_temp2 = df1.copy()
#     df_temp2.reset_index(drop=True, inplace=True)
#     first_non_zero = df_temp2['historical_sale'].ne(0).idxmax()
...
# # New code version_2.2.10_1
# # Only "use_damp_trend" has been changed from old code and "n_jobes = -1"
def tbats_sktime(df1, forecast_length,sp=[3,12],use_trend=True, use_damped_trend=None, use_arma_errors=False,
          use_box_cox=False):
