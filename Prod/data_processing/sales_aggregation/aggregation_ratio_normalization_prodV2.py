...
# agg_dis_agg_tmp = agg_dis_agg.copy()
# agg_dis_agg_tmp['key'] = agg_dis_agg_tmp['org_unit_id'] + agg_dis_agg_tmp['channel_id'] + agg_dis_agg_tmp['product_id']
# agg_dis_agg_tmp['key'].nunique()
