...
transitioned_future_forecast_master = spark.read.csv(f"/mnt/disk/staging_data/prod/{domain}/transitioned_raw_future_forecast_master_{domain}.csv",inferSchema=True,header=True)
