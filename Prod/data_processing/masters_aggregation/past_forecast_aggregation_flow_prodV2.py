...
transitioned_past_forecast_master = spark.read.csv(f"/mnt/disk/staging_data/prod/{domain_id}/transitioned_raw_past_forecast_master_{domain_id}.csv",inferSchema=True,header=True)
